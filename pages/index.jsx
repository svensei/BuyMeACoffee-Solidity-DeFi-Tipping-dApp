...
export default function Home() {
  ...
  const contractAddress = "0x88C3f4c9A4b324A145DA1e9123D92aBaEaA0b60b";
  ...
  const buyLCoffee = async () => {
    try {
      ...
      if (ethereum) {
        ...
        const coffeeTxn = await buyMeACoffee.buyLCoffee(
               name ? name : "anon",
          message ? message : "Enjoy your coffee!",
